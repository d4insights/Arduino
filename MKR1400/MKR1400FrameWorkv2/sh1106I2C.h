...
void displayError(String textoA, String textoB){
  ...
  u8g2.drawStr(9,53,"D");                               // X de ERROR !!!
...
void displayUbicacion(String textoA, String textoB){
  ...
  if(textoA != "" && textoB != ""){
      ...
      u8g2.drawStr(3,60,"G");                               // Simbolo de GeoLocalizacion
      
      u8g2.setFont(u8g2_font_6x10_tf);  
             
      u8g2.drawStr(35,27,"GEOLOCALIZACION");
      
      u8g2.setFont( u8g2_font_helvB08_tf);
      u8g2.drawStr(40,44,"lat:");
      u8g2.drawStr(40,59,"lon:");
      u8g2.drawStr(63,44,buffA);
      u8g2.drawStr(63,59,buffB);
...
void displayMessage(String textoA, String textoB){
  ...
  u8g2.drawStr(9,53,"N");                             // Signo de encendido
...
void startOled(){
   ...
   u8g2.drawXBMP(39, 6, d4i_Logo_width, d4i_Logo_height, d4i_Logo_bits); 
   u8g2.setFont( u8g2_font_helvB08_tf);          
   u8g2.drawStr(14,55,"www.d4insghts.com");      
   u8g2.sendBuffer();                          
}
...
void displayReloj(String dia, String hora){   
  ...
  u8g2.drawStr(17,37,cDia);
  u8g2.drawStr(36,61,cHora);     
                
  u8g2.setFont(u8g2_font_open_iconic_app_2x_t);
  u8g2.drawStr(111,64,"E");
