...
unsigned long ultimoRegistroDB = 0;                     // Auxiliar para manejo del períod de tiempo entre registros
long intervalRegistroBD        = 300000;                // Manejo del período de tiempo entre grabaciones en la BDatos


unsigned long ultimoRegistroAlertaDB = 0;                // Auxiliar para manejo del períod de tiempo entre registros
long intervalRegistroAlertaBD        = 300000;           // Manejo del período de tiempo entre grabaciones en la BDatos
