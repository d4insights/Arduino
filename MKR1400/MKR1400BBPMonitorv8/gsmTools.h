...
void modemConnect(){
  ...
  gsmAccess.setTimeout(30000);                   // TimeOut para la conexión telefónica
  gprs.setTimeout(30000);                        // TimeOut para la conexión de Internet Va en milisegundos y -1 es el default.. no timeout!!
