...
void setup() {
  ...
  Wire.begin(8);                 // Inicia la transmisión del I2C como Slave
...
void loop() {
  ...
  //tensionAC();
  //tensionBAT(VB, CantBaterias);   // Leo el estado de las baterías conectada
...
void requestEvent() {
 Wire.write("0123456789");  /*send string on request */
}
